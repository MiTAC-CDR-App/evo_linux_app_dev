...
/* enumerations from "../../../../gstreamer-1.14.4/libs/gst/controller/gstinterpolationcontrolsource.h" */
GST_CONTROLLER_API
GType gst_interpolation_mode_get_type (void);
#define GST_TYPE_INTERPOLATION_MODE (gst_interpolation_mode_get_type())

/* enumerations from "../../../../gstreamer-1.14.4/libs/gst/controller/gstlfocontrolsource.h" */
GST_CONTROLLER_API
